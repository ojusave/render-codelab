    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col gap-8 px-6 py-16">
        <div className="space-y-4">
          ...
          <h1 className="font-[family-name:Roboto] text-4xl font-light leading-tight text-neutral-950 md:text-5xl">
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <Link
            className="workshop-btn-ghost inline-flex items-center justify-center border border-neutral-300 px-6 py-3 text-base font-medium"
        ...
        <section className="rounded-none border border-neutral-200 bg-neutral-50 p-6">
          <h2 className="mb-2 font-[family-name:Roboto] text-xl font-light text-neutral-950">
            Session URL
          </h2>
          <p className="text-sm text-neutral-600">
            Students open{" "}
            <code className="rounded border border-neutral-200 bg-white px-1.5 py-0.5 font-mono text-xs">
              /s/&lt;code&gt;
            </code>{" "}
            . Tutors open{" "}
            <code className="rounded border border-neutral-200 bg-white px-1.5 py-0.5 font-mono text-xs">
